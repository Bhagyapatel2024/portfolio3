...
const experiences = [
  ...
  {
    title: "Gujarat Higher Secondary Education Board (GHSEB)",
    company_name: "Arpan School , Ahmedabad",
    company_website: "",
    icon: nickelfox, // Ensure nickelfox is properly imported or defined
    iconBg: "#E6DEDD",
    date: "Dec 2021",
  ...
  {
    title: "Gujarat Secondary Education Board (GSEB)",
    company_name: "Nishan School , Ahmedabad",
    company_website: "",
    icon: nickelfox, // Ensure nickelfox is properly imported or defined
    iconBg: "#E6DEDD",
    date: "Dec 2021",
...
const projects = [
  {
    ...
    image: "project-10.png", // Ensure image paths are correct
